...
// BLOCKED  thread 'main' panicked at 'called `Result::unwrap()` on an `Err` value: Immediate18TooLarge { val: 262256, span: Span { src (ptr): 0x600012cb7b50, path: None, start: 0, end: 0, as_str(): "" } }'
// #[tokio::test]
...
// BLOCKED Gives error: thread 'main' panicked at 'called `Result::unwrap()` on an `Err` value: Immediate18TooLarge { val: 262151, span: Span { src (ptr): 0x600013668f70, path: None, start: 0, end: 0, as_str(): "" } }', sway-core/src/asm_lang/virtual_ops.rs:866:18
// #[test]
// fn test_squaring() {
//     let a = Fp2 {
//         c0: fp_from_raw_unchecked([
