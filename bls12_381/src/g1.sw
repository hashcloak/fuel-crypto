...
//         self.infinity.binary_and(other.infinity).binary_or((self.infinity.not()).binary_and(other.infinity.not()).binary_and(self.x.ct_eq(other.x)).binary_and(self.y.ct_eq(other.y)))
//     }
// }
...
//         self_is_zero.binary_and(other_is_zero).binary_or(((Choice::not(self_is_zero)).binary_and(Choice::not(other_is_zero)).binary_and(x1.ct_eq(x2).binary_and(y1.ct_eq(y2)))))
//     }
// }
