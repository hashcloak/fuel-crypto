...
pub fn tests_shiftRightBy51() -> bool {
    assert(test_shiftRightBy51_random());
    assert(test_shiftRightBy51_random_2());
    assert(test_shiftRightBy51_random_3());
    true
}
...
fn test_shiftRightBy51_random_2() -> bool {
    /*
...
fn test_shiftRightBy51_random_3() -> bool {
    /*
