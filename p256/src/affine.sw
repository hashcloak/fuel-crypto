...
impl AffinePoint {
    ...
    pub fn generator() -> Self {
      ...
      AffinePoint {
        x: FieldElement{ls: [17627433388654248598, 8575836109218198432, 17923454489921339634, 7716867327612699207]}.fe_to_montgomery(),
        y: FieldElement{ls: [14678990851816772085, 3156516839386865358, 10297457778147434006, 5756518291402817435]}.fe_to_montgomery(),
        infinity: 0,
      }
